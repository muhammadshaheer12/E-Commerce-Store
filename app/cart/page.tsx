...
const Cart = () => {
    ...
    return (
        <div className="min-h-screen bg-yellow-300 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                {cart.length === 0 ? (<>
                    ...
                    <div className="bg-yellow-300 shadow-lg rounded-lg p-6 mb-8">
                        {cart.map((product) => (
                            <div key={product.id} className="flex flex-col md:flex-row items-center mb-6 border-b pb-6">
                                ...
                                <div className="flex-grow flex flex-col justify-center items-center gap-2">
                                    ...
                                    <div className="flex items-center space-x-4 mt-2">
                                        ...
                                        <button
                                            onClick={() => handleQuantityChange(product.id, 1)}
                                            className="bg-yellow-500 text-white w-8 h-8 flex items-center justify-center rounded-lg hover:bg-yellow-600"
                                        >
                                            +
                                        </button>
                                    </div>
