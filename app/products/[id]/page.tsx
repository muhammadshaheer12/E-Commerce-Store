    ...
    return (
        <div className="bg-yellow-300 min-h-screen py-12">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-yellow-300 p-8 rounded-lg shadow-lg flex flex-col md:flex-row">
                        {/* Product Image */}
                        ...
                        <div className="md:w-1/2 md:pl-8">
                            {data && (
                                <>
                                    ...
                                    <p className="text-2xl text-yellow-900 font-bold mb-4">${data.price}</p>
                            ...
                            <button
                                ...
                                className="bg-gray-900 text-white py-3 px-6 rounded-md hover:bg-gray-800"  
                            >
                                Add to Cart
                            </button>
                        </div>
