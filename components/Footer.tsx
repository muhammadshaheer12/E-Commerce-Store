        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400">
              Shop for the best products at the best prices. We have a wide range of products to choose from. Shop now!
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {/* GitHub */}
              <a href="https://github.com/muhammadshaheer12" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
              ...
              {/* LinkedIn */}
             <a href="https://www.linkedin.com/in/muhammad-shaheer12/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
