...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, onSubmit, cart, form, handleInputChange }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
      <div className="bg-yellow-100 p-6 rounded-lg shadow-lg w-full max-w-lg relative max-h-[80vh] overflow-y-auto">
        <button
          onClick={onClose}
        ...
        <h2 className="text-2xl font-semibold text-white mb-4 text-center">Checkout</h2>
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-black text-center mb-2">Order Summary</h3>
          {cart.length === 0 ? (
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="bg-gray-900 text-white py-2 px-4 rounded-md hover:bg-gray-800 w-full"
          >
            Place Order
          </button>
        </form>
